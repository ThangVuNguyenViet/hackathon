...
1. [`Verify And Freeze The Menu And Modifier Snapshot`](../issues/03-verify-and-freeze-menu-and-modifier-snapshot.md) must identify one official-source-backed fixture version, prove modifier ownership and cardinality, and remove ambiguity about which combos permit spicy chicken or upsized drinks.
