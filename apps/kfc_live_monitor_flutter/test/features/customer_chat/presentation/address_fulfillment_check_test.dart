...
void main() {
  ...
  testWidgets('does not enable confirm while a required field is empty', (
    ...
    expect(confirm.backgroundColor, KfcOpsTokens.surfaceContainerLow);
    expect(confirm.foregroundColor, KfcOpsTokens.secondary);
  });
...
KfcGenUiAttachment _addressAttachment({Map<String, Object?>? addressDraft}) {
