...
export const gatewayOmsCreateEvidenceSchema = z.object({
  ...providerRuntimeSchema,
  omsOrderId: identifierSchema,
  omsStatus: z.literal("created"),
}).strict();

export const gatewayOmsCreateFailureEvidenceSchema = z.object({
...
export const gatewayPosSubmitEvidenceSchema = z.object({
  ...providerRuntimeSchema,
  omsOrderId: identifierSchema,
...
export const gatewayPosRejectionEvidenceSchema = z.object({
  traceId: identifierSchema,
  scenarioId: identifierSchema,
  commerceOrderId: identifierSchema,
  omsOrderId: identifierSchema,
...
export const gatewayOmsCancellationEvidenceSchema = z.object({
  ...providerRuntimeSchema,
  omsOrderId: identifierSchema,
  omsStatus: z.literal("cancelled"),
}).strict();

export const gatewayOmsCancellationFailureEvidenceSchema = z.object({
...
export const gatewayPosCancellationEvidenceSchema = z.object({
  ...providerRuntimeSchema,
  omsOrderId: identifierSchema,
  posTicketId: identifierSchema,
...
export const gatewayPosCancellationFailureEvidenceSchema = z.object({
