...
function presentedMenuOrdinalIndex(text: string): number | undefined {
...
function compactPlannerMenuCatalogContext(context: MenuPlanningContext | undefined) {
  ...
  return {
    ...
    candidates: context.candidates.map((candidate) => ({
      ...
      presentedMenuItem: candidate.presentedMenuItem,
...
const plannerInstructions = [
  ...
  'For a positional or deictic follow-up such as first, this item, or this combo, resolve the reference against state.menuSearchResults in its displayed order. The matching current menuCatalogContext candidate is marked presentedMenuItem. Never substitute the first newly searched candidate.',
