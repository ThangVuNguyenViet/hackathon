...
export async function loadAgentTurnContext(
  ...
  const state: AgentGraphState = {
    ...
    promotionOffers: priorVerifiedState.promotionOffers,
    contentEvidence: priorVerifiedState.contentEvidence,
    menuSearchResults: priorVerifiedState.menuSearchResults,
    verifiedCollections: priorVerifiedState.verifiedCollections,
    activeCollectionKeys: priorVerifiedState.activeCollectionKeys,
    activeMenuCollection: priorVerifiedState.activeMenuCollection,
    commerceApprovalReceipts: priorVerifiedState.commerceApprovalReceipts,
    selectedModifiers: priorVerifiedState.selectedModifiers,
