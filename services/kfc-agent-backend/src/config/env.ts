...
const appEnvSchema = z.object({
  ...
  TOOL_PLANNER_MODEL: z.string().optional().default(""),
  TOOL_PLANNER_FAST_MODEL: z.string().optional().default(""),
  TOOL_PLANNER_STATUS_MODEL: z.string().optional().default(""),
  VERTEX_SERVICE_ACCOUNT_JSON: z.string().optional().default(""),
