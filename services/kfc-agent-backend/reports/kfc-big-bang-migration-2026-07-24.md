...
The live qualification preserved 64 run directories: 55 completed runs, two
failed runs, six failed preflights, and one abandoned ready run. This includes
three focused OpenAI repair-loop runs and ten post-remediation cross-model
canary artifacts. Four independent model-blind
...
The first configured turn atomically pins the full deployment-owned candidate
and profile identity in the scoped session state. A resumed turn must present
...
- MiniMax s01 attempt 1 used a malformed scenario path and failed before an
  artifact directory existed. It is not one of the 64 indexed directories.
...
## Post-remediation cross-model canary

The v5/v6 canaries ran at final HEAD `096e9883` after the protected-commerce,
PVCFC, and model-binding fixes. Ordinary text never exposed or executed a cart,
order, payment, or voucher mutation in any completed canary.

- OpenAI, MiniMax, and Qwen completed v6 with zero protected mutations.
- DeepSeek v6 attempt 1 hit its known invalid-`searchMenu` recursion failure
  before confirmation; attempt 2 used exact item code `20690`, completed two
  turns, and exposed only the read-only `getItemDetails` tool.
- The authority boundary therefore passed, but conversational grounding is not
  fully qualified: OpenAI falsely said an empty cart had been updated; Qwen
  emitted invalid calls and implied an uncreated handoff; MiniMax made an
  unsupported store-availability claim; the first DeepSeek attempt exhausted
...
| `20260724-v5-deepseek-v4-flash-s01-a1`                       | DeepSeek |       01 |       1 | `completed`        | [T](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-deepseek-v4-flash-s01-a1/transcript.md) [J](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-deepseek-v4-flash-s01-a1/trace.jsonl) [M](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-deepseek-v4-flash-s01-a1/manifest.json) [P](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-deepseek-v4-flash-s01-a1/preflight.json) [R](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-deepseek-v4-flash-s01-a1/codex-review-packet.md)                                                                                                                                |
| `20260724-v5-deepseek-v4-flash-s01-a1-attempt2-no-langsmith` | DeepSeek |       01 |       2 | `completed`        | [T](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-deepseek-v4-flash-s01-a1-attempt2-no-langsmith/transcript.md) [J](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-deepseek-v4-flash-s01-a1-attempt2-no-langsmith/trace.jsonl) [M](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-deepseek-v4-flash-s01-a1-attempt2-no-langsmith/manifest.json) [P](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-deepseek-v4-flash-s01-a1-attempt2-no-langsmith/preflight.json) [R](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-deepseek-v4-flash-s01-a1-attempt2-no-langsmith/codex-review-packet.md)                  |
| `20260724-v5-minimax-m3-s01-a1`                              | MiniMax  |       01 |       1 | `completed`        | [T](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-minimax-m3-s01-a1/transcript.md) [J](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-minimax-m3-s01-a1/trace.jsonl) [M](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-minimax-m3-s01-a1/manifest.json) [P](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-minimax-m3-s01-a1/preflight.json) [R](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-minimax-m3-s01-a1/codex-review-packet.md)                                                                                                                                                                   |
| `20260724-v5-openai-gpt-4.1-mini-s01-a1`                     | OpenAI   |       01 |       1 | `completed`        | [T](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-openai-gpt-4.1-mini-s01-a1/transcript.md) [J](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-openai-gpt-4.1-mini-s01-a1/trace.jsonl) [M](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-openai-gpt-4.1-mini-s01-a1/manifest.json) [P](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-openai-gpt-4.1-mini-s01-a1/preflight.json) [R](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-openai-gpt-4.1-mini-s01-a1/codex-review-packet.md)                                                                                                                      |
| `20260724-v5-qwen3.7-max-s01-a1`                             | Qwen     |       01 |       1 | `completed`        | [T](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-qwen3.7-max-s01-a1/transcript.md) [J](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-qwen3.7-max-s01-a1/trace.jsonl) [M](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-qwen3.7-max-s01-a1/manifest.json) [P](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-qwen3.7-max-s01-a1/preflight.json) [R](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v5-qwen3.7-max-s01-a1/codex-review-packet.md)                                                                                                                                                              |
| `20260724-v6-deepseek-v4-flash-s01-a1`                       | DeepSeek |       01 |       1 | `failed`           | [T](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-deepseek-v4-flash-s01-a1/transcript.md) [J](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-deepseek-v4-flash-s01-a1/trace.jsonl) [M](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-deepseek-v4-flash-s01-a1/manifest.json) [P](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-deepseek-v4-flash-s01-a1/preflight.json) [R](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-deepseek-v4-flash-s01-a1/codex-review-packet.md)                                                                                                                                |
| `20260724-v6-deepseek-v4-flash-s01-a2`                       | DeepSeek |       01 |       2 | `completed`        | [T](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-deepseek-v4-flash-s01-a2/transcript.md) [J](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-deepseek-v4-flash-s01-a2/trace.jsonl) [M](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-deepseek-v4-flash-s01-a2/manifest.json) [P](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-deepseek-v4-flash-s01-a2/preflight.json) [R](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-deepseek-v4-flash-s01-a2/codex-review-packet.md)                                                                                                                                |
| `20260724-v6-minimax-m3-s01-a1`                              | MiniMax  |       01 |       1 | `completed`        | [T](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-minimax-m3-s01-a1/transcript.md) [J](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-minimax-m3-s01-a1/trace.jsonl) [M](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-minimax-m3-s01-a1/manifest.json) [P](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-minimax-m3-s01-a1/preflight.json) [R](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-minimax-m3-s01-a1/codex-review-packet.md)                                                                                                                                                                   |
| `20260724-v6-openai-gpt-4.1-mini-s01-a1`                     | OpenAI   |       01 |       1 | `completed`        | [T](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-openai-gpt-4.1-mini-s01-a1/transcript.md) [J](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-openai-gpt-4.1-mini-s01-a1/trace.jsonl) [M](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-openai-gpt-4.1-mini-s01-a1/manifest.json) [P](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-openai-gpt-4.1-mini-s01-a1/preflight.json) [R](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-openai-gpt-4.1-mini-s01-a1/codex-review-packet.md)                                                                                                                      |
| `20260724-v6-qwen3.7-max-s01-a1`                             | Qwen     |       01 |       1 | `completed`        | [T](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-qwen3.7-max-s01-a1/transcript.md) [J](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-qwen3.7-max-s01-a1/trace.jsonl) [M](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-qwen3.7-max-s01-a1/manifest.json) [P](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-qwen3.7-max-s01-a1/preflight.json) [R](kfc-big-bang-migration-2026-07-24-evidence/live-runs/20260724-v6-qwen3.7-max-s01-a1/codex-review-packet.md)                                                                                                                                                              |
