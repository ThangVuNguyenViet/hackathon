...
describe('KFC agent StateGraph', () => {
  it('owns the complete model, tool, approval, retry, and persistence loop', () => {
    ...
    expect(
      ...
      'call_response_model->fail_closed',
      'call_response_model->finalize_response',
      'call_response_model->record_provider_retry',
      'call_response_model->validate_tool_calls',
      ...
      'execute_trusted_action->call_response_model',
      ...
      'prepare_structured_action->call_response_model',
