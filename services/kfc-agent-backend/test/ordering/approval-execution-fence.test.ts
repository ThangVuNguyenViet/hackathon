...
async function fixture() {
  ...
  const claim: CommerceApprovalExecutionFenceClaim = {
    ...
    sourceTurnId: 'agent-thread-session-1',
    actionScope: '',
    actionId: 'checkpoint_1',
...
describe('commerce approval execution fence', () => {
  ...
  it.each([
    ...
    ['sourceTurnId', { sourceTurnId: 'agent-thread-session-2' }],
    ['actionScope', { actionScope: 'other' }],
    ['actionId', { actionId: 'checkpoint_2' }],
