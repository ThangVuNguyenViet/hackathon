...
function env(overrides: Partial<WorkerEnv> = {}): WorkerEnv {
  return {
    ...
    KFC_COMMERCE_GATEWAY_BASE_URL: process.env.KFC_COMMERCE_GATEWAY_BASE_URL,
    KFC_COMMERCE_GATEWAY_TOKEN: process.env.KFC_COMMERCE_GATEWAY_TOKEN,
    KFC_MENU_API_URL: process.env.KFC_MENU_API_URL,
    KFC_COMMERCE_ENVIRONMENT: process.env.KFC_COMMERCE_ENVIRONMENT as WorkerEnv['KFC_COMMERCE_ENVIRONMENT'],
