...
SOURCE_JOURNEY_SCHEMA = _schema(
    ...
    ("admissionOpportunityId", pa.string(), False),
    ...
    ("fulfilmentMode", pa.string(), False),
    ("daypart", pa.string(), False),
    ("starterRecommendationType", pa.string(), False),
    ("cartSubtotalVnd", pa.int64(), False),
    ("initialCartLineCount", pa.int16(), False),
    ("initialCartLineId", pa.string(), True),
    ("initialCartItemId", pa.string(), True),
    ("desiredSmartSlateSize", pa.int8(), False),
    ("heldOutStore", pa.bool_(), False),
    ("coldCustomer", pa.bool_(), False),
    ("coldCandidate", pa.bool_(), False),
    ("drift", pa.bool_(), False),
    ("demandMultiplier", pa.float64(), False),
    ("preferenceRegime", pa.string(), False),
    ("promotionRegime", pa.string(), False),
    ("availabilityRate", pa.float64(), False),
    ("rush", pa.bool_(), False),
)
...
TRAINING_SCHEMA = _schema(
    ...
    *FEATURE_FIELDS,
    ...
    ("slateId", pa.string(), True),
    ("renderedPosition", pa.int8(), True),
    ("slatePropensity", pa.float64(), True),
    ("selectionPropensity", pa.float64(), True),
...
OPPORTUNITY_SCHEMA = _schema(
    ...
    ("sequence", pa.int8(), False),
    ("recommendationType", pa.string(), False),
    ("placement", pa.string(), False),
    ("status", pa.string(), False),
    ("emptyReason", pa.string(), True),
    ("assignedCondition", pa.string(), False),
    ("treatmentPolicy", pa.string(), False),
    ("prerequisiteState", pa.string(), False),
    ("parentCartLineId", pa.string(), True),
    ("createdCartLineId", pa.string(), True),
    ("candidateCount", pa.int16(), False),
    ("slateId", pa.string(), True),
    ("slateSize", pa.int8(), False),
    ("slatePropensity", pa.float64(), True),
    ("outcomeClass", pa.string(), False),
    ("renderedActionIdsJson", pa.string(), False),
    ("selectedActionIdsJson", pa.string(), False),
    ("cartSubtotalBeforeVnd", pa.int64(), False),
    ("cartSubtotalAfterVnd", pa.int64(), False),
    ("cartLineCountBefore", pa.int16(), False),
    ("cartLineCountAfter", pa.int16(), False),
)

EXPOSURE_SCHEMA = _schema(
    ("seed", pa.int32(), False),
    ("journeyId", pa.string(), False),
    ("opportunityId", pa.string(), False),
    ("assignedCondition", pa.string(), False),
    ("recommendationType", pa.string(), False),
    ("slateId", pa.string(), False),
    ("actionId", pa.string(), False),
    ("candidateId", pa.string(), False),
    ("categoryId", pa.string(), False),
...
EVALUATION_JOURNEY_SCHEMA = _schema(
    ...
    ("starterRecommendationType", pa.string(), False),
    ("baseCartSubtotalVnd", pa.int64(), False),
    ("selectedActionIdsJson", pa.string(), False),
    ("retainedActionIdsJson", pa.string(), False),
    ("removedActionIdsJson", pa.string(), False),
    ("treatmentRevenueVnd", pa.int64(), False),
...
ORACLE_SCHEMA = _schema(
    ...
    ("terminalState", pa.string(), False),
    ("finalMerchandiseSubtotalVnd", pa.int64(), False),
    ("treatmentPathJson", pa.string(), False),
)

ARRIVAL_SCHEMA = _schema(
    ("trafficProfile", pa.string(), False),
    ("phase", pa.string(), False),
    ("seed", pa.int32(), True),
    ("minute", pa.string(), True),
    ("minuteOffset", pa.int32(), False),
    ("durationSeconds", pa.int16(), False),
    ("targetRps", pa.float64(), False),
    ("daypart", pa.string(), False),
    ("rush", pa.bool_(), False),
...
SCORER_SHAPE_SCHEMA = _schema(
    ("shapeClass", pa.string(), False),
    ("recommendationType", pa.string(), False),
    ("candidateCount", pa.int16(), False),
    ("expectedRenderedCount", pa.int16(), False),
    ("expectedMinimumCategoryDiversity", pa.int16(), False),
